...
export const ShareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.586.042h4.414c.196 0 .391-.017.586-.042M7.217 10.907a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zmm0 2.186a2.25 2.25 0 10-4.5 0 2.25 2.25 0 004.5 0zm4.414 0a2.25 2.25 0 100-2.186m0 2.186c-.195-.025-.39-.042-.586-.042h-4.414c-.196 0-.391.017-.586.042m5.86 0a2.25 2.25 0 104.5 0 2.25 2.25 0 00-4.5 0zm0-2.186a2.25 2.25 0 114.5 0 2.25 2.25 0 01-4.5 0z" />
  </svg>
);
