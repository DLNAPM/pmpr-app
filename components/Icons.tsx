...
export const WrenchScrewdriverIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.52.922 1.123 1.777 1.848 2.597l.484.484a.75.75 0 01-1.06 1.06l-.483-.484c-.72-.72-1.538-1.424-2.34-2.228l-3.03 2.496m0 0l-1.07-1.07a.75.75 0 010-1.06l3.03-2.496c-.804-.804-1.508-1.622-2.228-2.34l-.484-.483a.75.75 0 01-1.06-1.06l.484-.483c.82.72 1.675 1.323 2.597 1.848l2.496-3.03m-2.496 3.03l-3.03-2.496a.75.75 0 01-1.06 0l-1.07 1.07a.75.75 0 01-1.06 0l-3.03-2.496a.75.75 0 010-1.06l1.07-1.07a.75.75 0 011.06 0l2.496 3.03" />
    </svg>
);

export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663l.001.109m-8.374 2.46l.001.109a6.375 6.375 0 0011.964-4.663l-.001-.109m-8.374-5.62a3.375 3.375 0 116.75 0 3.375 3.375 0 01-6.75 0z" />
  </svg>
);
...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24px" height="24px" {...props}>
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571l6.19,5.238C39.712,35.618,44,29.612,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
);
...
export const CurrencyDollarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.553-.44 1.278-.659 2.003-.659 1.519 0 2.986 1.603 3.465 3.182" />
    </svg>
);
...
export const DocumentChartBarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 1.5m1-1.5l1 1.5m0 0l.5 1.5m.5-1.5h.5m2.25-3.375l-2.25 2.25-2.25-2.25" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5a5.25 5.25 0 11-10.5 0 5.25 5.25 0 0110.5 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 12.75h4.5" />
    </svg>
);
...
export const ShareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.044.586.06.3.027.608.052.916.075a10.473 10.473 0 015.06 1.052M7.217 10.907a2.25 2.25 0 110 2.186m0-2.186c-.195.025-.39.044-.586.06-.3.027-.608.052-.916.075a10.473 10.473 0 00-5.06 1.052M14.783 13.093a2.25 2.25 0 100-2.186m0 2.186c-.195-.025-.39-.044-.586-.06-.3-.027-.608-.052-.916-.075a10.473 10.473 0 01-5.06-1.052M14.783 13.093a2.25 2.25 0 110-2.186m0 2.186c.195-.025.39-.044.586-.06.3-.027.608-.052.916-.075a10.473 10.473 0 005.06-1.052" />
...
export const CalendarDaysIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5a2.25 2.25 0 002.25-2.25m-18 0V15h18v3.75M7.5 11.25h.008v.008H7.5v-.008zm3.75 0h.008v.008H11.25v-.008zm3.75 0h.008v.008H15v-.008zm3.75 0h.008v.008H18.75v-.008zm-11.25 3.75h.008v.008H7.5v-.008zm3.75 3.75h.008v.008H11.25v-.008zm3.75 3.75h.008v.008H15v-.008zm3.75 3.75h.008v.008H18.75v-.008z" />
  </svg>
);
